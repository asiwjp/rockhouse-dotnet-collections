...
namespace RockHouse.Collections
{
    ...
    public static class DictionaryUtils
    {
        ...
        /// <summary>
        /// Returns an default dictionary if the specified dictionary is null.
        /// </summary>
        /// <typeparam name="K">The type of keys.</typeparam>
        /// <typeparam name="V">The type of values.</typeparam>
        /// <param name="dictionary">Target to determine if it is null or not.</param>
        /// <param name="defaultDictionary">The default dictionary.</param>
        /// <returns>If the specified dictionary is null, defaultDictionary is returned. Otherwise, the original dictionary is returned as is.</returns>
        public static IDictionary<K, V> DefaultIfNull<K, V>(IDictionary<K, V>? dictionary, IDictionary<K, V> defaultDictionary)
        {
            return DefaultIfNull(dictionary, () => defaultDictionary);
        }
        ...
        /// <param name="dictionary">Target to determine if it is null or not.</param>
        /// <param name="factory">Factory functor to generate default dictionary.</param>
        /// <returns>If the specified dictionary is null, the default value generated by the factory is returned. Otherwise, the original dictionary is returned as is.</returns>
        public static IDictionary<K, V> DefaultIfNull<K, V>(IDictionary<K, V>? dictionary, Func<IDictionary<K, V>> factory)
        {
            if (factory == null)
            {
                throw new ArgumentNullException(nameof(factory));
